...
| 1.5 | Understanding Collections | 10 min | [Script](./scripts/05-collections.md) |

### Series 2: Query Mastery (Intermediate)
| Video | Title | Duration | Status |
|-------|-------|----------|--------|
...
| Video | Title | Duration | Status |
|-------|-------|----------|--------|
| 4.1 | Production Deployment | 15 min | [Script](./scripts/15-deployment.md) |
| 4.2 | High Availability | 12 min | [Script](./scripts/16-ha.md) |
| 4.3 | Backup & Recovery | 10 min | [Script](./scripts/17-backup.md) |
| 4.4 | Security Best Practices | 12 min | [Script](./scripts/18-security.md) |
...
- **Frame Rate**: 60fps for code demos
- **Audio**: Clear voiceover with background music at 10% volume
- **Code Font**: JetBrains Mono, 18pt
- **Terminal Theme**: Dark (Dracula or similar)

### Structure Template
1. **Intro** (30 sec): Title card + brief overview
2. **Concept** (2-3 min): Explain the topic
3. **Demo** (5-10 min): Live coding demonstration
4. **Summary** (1 min): Key takeaways
5. **Next Steps** (30 sec): What to learn next

---

## Detailed Video Scripts

See the [scripts](./scripts/) directory for complete video scripts.
